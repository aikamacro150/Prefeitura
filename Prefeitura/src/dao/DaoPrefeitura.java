...
public class DaoPrefeitura {
    public static boolean inserir(Prefeitura objeto) {
        String sql = "INSERT INTO prefeitura (nome, endereco, codigo, nr_de_funcionarios ) VALUES (?, ?, ?, ?)";
        try {
    ...
    public static void main(String[] args) {
        ...
        objeto.setNr_de_funcionarios(10);
        objeto.setCodigo(1);
    ...
    public static boolean alterar(Prefeitura objeto) {
        String sql = "UPDATE produto SET nome = ?, endereco = ?, nr_de_funcionarios = ? WHERE codigo=?";
        try {
            PreparedStatement ps = conexao.Conexao.getConexao().prepareStatement(sql);
            ps.setString(1, objeto.getNome()); 
            ps.setString(2, objeto.getEndereco());
     ...
     public static List<Prefeitura> consultar() {
        ...
        String sql = "SELECT codigo, nome, endereco, nrdefuncionario FROM Prefeitura";
        ...
        try {
            ...
            while (rs.next()) {
                ...
                objeto.setNr_de_funcionarios(rs.getInt("Numero de Funcionarios"));
